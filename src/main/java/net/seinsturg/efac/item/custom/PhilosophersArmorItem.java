...
public class PhilosophersArmorItem extends ArmorItem {
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(EvansArmorMaterials.PHILOSOPHERS_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.JUMP, 200, 1, false, false),
                                    new MobEffectInstance(MobEffects.LUCK, 200, 1, false, false)))
                    .build();

    public PhilosophersArmorItem(Holder<ArmorMaterial> material, Type type, Properties properties) {
